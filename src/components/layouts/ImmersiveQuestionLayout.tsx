...
export function ImmersiveQuestionLayout({
  form,
  theme = defaultTheme,
  headerImageUrl,
  isPreview,
  ...
  const ProgressBar = ({ showQuestionCount = true }: { showQuestionCount?: boolean }) => (
    <div className="w-full">
      ...
      {showQuestionCount && (
        <div className="mt-2 flex justify-between items-center text-sm" style={{ color: theme.colors.textSecondary }}>
          ...
          <div className="max-w-md w-full relative z-10">
            ...
            >
              ...
              <button
                ...
                className="w-full px-8 py-4 text-lg font-medium text-white rounded-lg transition-all hover:opacity-90"
      ...
      <div className={`${isPreview ? 'h-full' : 'min-h-screen'} flex flex-col lg:flex-row`}>
        ...
        <div className="flex-1 relative overflow-auto">
          ...
          <div className="relative z-10 p-6 lg:p-12">
            <div
              className="max-w-xl mx-auto rounded-2xl shadow-lg p-6 sm:p-8"
              style={{ backgroundColor: theme.colors.surface }}
            >
              <h2
                ...
                {form.questions.map((question, index) => {
                  ...
                  return (
                    <button
                      ...
                      className="w-full text-left p-4 rounded-lg border-2 transition-all hover:border-opacity-70"
                      style={{
              ...
              <div className="mt-8 flex flex-col sm:flex-row gap-4">
                <button
                  ...
                  className="px-6 py-3 border-2 rounded-lg transition-all hover:opacity-80"
                  style={{
                    borderColor: theme.colors.border,
                ...
                <button
                  ...
                  className="flex-1 px-8 py-3 text-lg font-medium text-white rounded-lg transition-all"
                  style={{
  ...
  return (
    <div className={`${isPreview ? 'h-full' : 'min-h-screen'} flex flex-col lg:flex-row`}>
      ...
      <div className="flex-1 flex flex-col relative">
        ...
        >
          ...
          >
            ...
            <div className="mt-8 flex justify-between items-center">
              ...
              <button
                onClick={handleNext}
                className="flex items-center gap-2 px-6 py-2 text-white rounded-lg transition-all hover:opacity-90"
                style={{ backgroundColor: theme.colors.primary }}
        ...
        {/* Desktop Progress Bar in left panel */}
        <div className="hidden lg:block p-6 relative z-10">
          <div
            className="max-w-xl mx-auto rounded-lg p-4"
