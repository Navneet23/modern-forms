...
export function Paragraph({ question, value, onChange, error, theme }: ParagraphProps) {
  ...
  return (
    <div className="space-y-2">
      ...
      <textarea
        ...
        rows={4}
        className="w-full px-4 py-3 text-base border-2 rounded-lg transition-all resize-y"
        style={{
